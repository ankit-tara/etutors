<?php
$test_id = isset($_GET['et']) ? base64_decode($_GET['et']) : '';
...
$home_url = home_url() . '/instructor-profile/student-tests/?et=' .base64_encode($test['user_id']);
...
<main class="main-content bgc-grey-100">
    <div id="mainContent">
        <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Student Name : <?php echo $current_user ? $current_user->display_name : '' ?>
                    </h5>
                    <p class="card-text">
                ...
                <div class="card-body">
                    <div class="form">
                        <div class="form-group">
                            ...
                            <input class="form-control t-score" type="number" name="score"
                                value="<?php echo $test['score'] ?>">
